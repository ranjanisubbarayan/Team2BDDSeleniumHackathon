...
public class MyPatientsPage {
	...
	public boolean doesColumnHaveValues(String column) {
		...
		List<WebElement> columnCells = driver.findElements(By.xpath("//table//tbody//tr/td[" + index + "]"));
	...
	public boolean arePaginationControlsDisplayed() {
		...
		return firstPageArrow.isDisplayed() && previousPageArrow.isDisplayed() && nextPageArrow.isDisplayed()
