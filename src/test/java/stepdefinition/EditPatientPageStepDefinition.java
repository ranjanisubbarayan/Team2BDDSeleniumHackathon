...
public class EditPatientPageStepDefinition {
	...
	@Given("User is on My Patients page to edit a patient")
	public void user_is_on_my_patients_page_to_edit_a_patient() {
		logger.info("User is on My Patients page to edit a patient");
	}
	...
	public void user_should_see_in_the_editpage(String fieldName) {
		...
		switch (key) {
		case "submit button":
			Assert.assertTrue(pom.getEditPatientPage().isSubmitButtonDisplayed(), "Submit button is not displayed");
			break;
		case "close button":
			Assert.assertTrue(pom.getEditPatientPage().isCloseButtonDisplayed(), "Close button is not displayed");
			break;
	...
	public void user_should_see_the_field_populated_with_the_entered_during_patient_creation(String field_name,
			String expectedvalue) {
		String actualValue = pom.getEditPatientPage().getFieldValue(field_name);
		logger.info("Validating field '{}' is populated. Actual value {} whereas expected value is {} ", field_name,
	...
	public void user_should_see_no_file_choosen_text_in_the_edit_patient_page() {
		Assert.assertTrue(pom.getEditPatientPage().isnoFileChosenTextDisplayed(), "Expected text is not displayed ");
	}
	...
	public void user_should_see_placeholder_in_the_edit_patient_page(String placeholdername) {
		Assert.assertTrue(pom.getEditPatientPage().isPlaceholderDisplayed(placeholdername),
	...
	public void user_should_see_after_redirected_to_my_patient_with_edited_value_in_first_name(String result) {
		Assert.assertTrue(ElementUtil.getURL().toLowerCase().contains("mypatient"),
				"User is not redirected to My Patient page");
	...
	public void user_clicks_submit_after_entering_a_in_the_field_in_the_edit_patient_page(String validvalue,
			String field) {
	...
	public void user_should_be_redirected_to_the_my_patient_page_with_the_updated_value_as(String field,
			String validvalue) {
		Assert.assertTrue(ElementUtil.getURL().toLowerCase().contains("mypatient"),
				"User is not redirected to My Patient page");
		Assert.assertTrue(pom.getMyPatientsPage().isPatientNameDisplayedForAllRows());
	...
	public void user_clicks_view_previous_test_report_after_being_redirected_to_the_my_patient_page_for_updating_value(
			String string) {
	...
	public void user_clicks_submit_after_entering_a_valid_in_the_field_only_in_the_edit_patient_page(String value,
			String field) {
	...
	public void user_clicks_submit_after_entering_valid_values_in_sp_and_dp_fields_in_the_edit_patient_page(String sp,
			String dp) {
	...
	public void user_clicks_view_previous_test_report_after_being_redirected_to_the_my_patient_page_for_updating_the_sp_and_dp_value(
	...
	public void user_should_see_the_error_message_for_invalid_file_upload_scenarios_in_the_editpatient_page(
